...
L_out7Seg12:
	...
	MOVWF       LATD+0 
	GOTO        L_out7Seg2
;Projeto_2.c,30 :: 		default:{ latd = 0b00000000; break;} // entrada inv�lida, apagar display
L_out7Seg13:
	CLRF        LATD+0 
	GOTO        L_out7Seg2
;Projeto_2.c,31 :: 		}
...
;Projeto_2.c,44 :: 		if(INTCON.TMR0IF == 1)    //Foi o TIMER0 que gerou a interrup��o ?
	BTFSS       INTCON+0, 2 
...
;Projeto_2.c,50 :: 		TMR0L = TMR0L_preset;
	...
	MOVWF       TMR0L+0 
;Projeto_2.c,51 :: 		INTCON.TMR0IF = 0;   //N�o esquecer de zerar a Flag
	BCF         INTCON+0, 2 
;Projeto_2.c,52 :: 		}
...
;Projeto_2.c,75 :: 		INTCON.GIE = 1;
	BSF         INTCON+0, 7 
;Projeto_2.c,77 :: 		INTCON.TMR0IE = 1;   //Habilita a interrup��o individual do TIMER0
	BSF         INTCON+0, 5 
;Projeto_2.c,78 :: 		INTCON.INT0IE = 1; //Habilita a interrup��o espec�fica INT0
	BSF         INTCON+0, 4 
;Projeto_2.c,79 :: 		INTCON3.INT1IP = 1; // Interrupc�o INT1 em alta prioridade
	BSF         INTCON3+0, 6 
;Projeto_2.c,80 :: 		INTCON3.INT1IE = 1; //Habilita a interrup��o espec�fica INT1
	BSF         INTCON3+0, 3 
...
;Projeto_2.c,89 :: 		ADCON1 |= 0x0F;
	MOVLW       15
	IORWF       ADCON1+0, 1 
;Projeto_2.c,91 :: 		TRISD = 0;    // PORTD como sa�da  (usar LED)
	CLRF        TRISD+0 
